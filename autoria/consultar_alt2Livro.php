    ...
    <div class="container">
        ...
        <fieldset>
            ...
            <form name="cliente2" method="POST" action="">
                ...
                <b><?php echo "Cod livro: ". $pro_mostrar[0]; ?></b>
                <br><br>
                <b><?php echo "Titulo: " ;?></b>
                ...
                <br><br>
                <b><?php echo "ISBN: " ;?></b>
                <input type="text" name="txtemail" size="25" value='<?php echo $pro_mostrar[3]?>' onkeypress="return blokletras(window.event.keyCode)" required>
                <br><br>
                <b><?php echo "idioma: " ;?></b>
                <input type="text" name="txtidiomas" size="25" value='<?php echo $pro_mostrar[4]?>' required>
                <br><br>
                <b><?php echo "Paginas: " ;?></b>
                <input type="text" name="txtnasc" size="25" value='<?php echo $pro_mostrar[5]?>' onkeypress="return blokletras(window.event.keyCode)" required>
                <br><br><br>
                <?php
                }
                ?>
        ...
        if(isset($btnalterar))
        {
            ...
            $pro->setIdioma($txtidiomas);
            $pro->setQtdePag($txtnasc);
            $pro->setCod_livro($txtid);
            echo "<br><br><h3>". $pro->alterar2() . "</h3>";
            header("location:consultar_altLivro.php");      
        }
        ?>
    </div>
</body>
